...
export default {
    ...
    mounted: function(){
       this.fillHotspotInput();
    },
    methods: {
        fillHotspotInput: function(){
            let searchCounter = 1;
            let column = '';
            document.querySelector('#search-column-2').innerHTML+= `<div class="search-page-title-hotspot">${this.title}</div>`;
